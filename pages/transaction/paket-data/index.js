...
class TransactionPaketData extends React.Component {
  ...
  async componentDidMount() {
    ...
    await localStorage.setItem("productType", slugPaketData);
  ...
  async changeInput(e) {
    ...
    // set disable warning when input > 10 and < 14
    if (
  ...
  render() {
    ...
    return (
      <div className="App">
        <Header header="Paket Data" routerBack="/" />
        {/* call loading page */}
        ...
        <Input
          ...
          name="phone_number"
        />
        <HistoryTransaction imageProduct="/static/transaction/icon-paketdata.svg" />
        <Nominal
