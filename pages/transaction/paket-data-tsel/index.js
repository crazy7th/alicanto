...
import Nominal from "../../../components/Dummy/NominalDummy";
    ...
    return (
      <div className="App">
        ...
        <div className="section section-plnwarning mt0">
          <p>
            Bonus Kuota Midnight berlaku 30 hari (bisa dipergunakan pada pukul
            00:01 - 06:59) dan dapat diperoleh setelah pelanggan melakukan
            pembelian semua kota (berlaku nasional)
          </p>
          <img
